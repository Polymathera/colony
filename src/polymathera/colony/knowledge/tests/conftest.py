"""Same registry guards as the convergence-runtime + tools tests —
pytest's import-mode=importlib namespace-package quirks otherwise
trigger duplicate-Counter / duplicate-Table errors when modules are
loaded twice."""
