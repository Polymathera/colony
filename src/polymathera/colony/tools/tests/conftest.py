"""Same registry guards as the convergence-runtime + design-monorepo
tests; pytest's import-mode=importlib namespace-package quirks
otherwise trigger duplicate-Counter / duplicate-Table errors when
